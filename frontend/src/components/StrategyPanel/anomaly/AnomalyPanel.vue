...
// Собственная веб-панель пакета anomaly (см. internal/strategy/anomaly) -
// зарегистрирована в StrategiesDialog.vue по IDName. У anomaly есть оба
// независимых тумблера: сам детектор и его уведомления.
...
<template>
  <div class="strategy-panel">
    ...
    <div class="strategy-panel-hint">Детектор аномальных всплесков цены/объёма/сделок по парам</div>
